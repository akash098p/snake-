...
const COLLECTIBLE_TYPES = {
    coin: { emoji: "🪙", color: "#f0c828", weight: 12 },
    diamond: { emoji: "💎", color: "#8cdcff", weight: 2 }
};

const FOOD_TYPES = {
    apple: { color: "#dc1414", points: 10, emoji: "🍎", weight: 40 },
    banana: { color: "#ffff00", points: 15, emoji: "🍌", weight: 25 },
    cherry: { color: "#8b0000", points: 20, emoji: "🍒", weight: 20 },
    grape: { color: "#8a2be2", points: 25, emoji: "🍇", weight: 15 },
    orange: { color: "#ffa500", points: 12, emoji: "🍊", weight: 30 },
    strawberry: { color: "#ff1493", points: 18, emoji: "🍓", weight: 25 },
    watermelon: { color: "#32cd32", points: 30, emoji: "🍉", weight: 10 },
    pineapple: { color: "#ffd700", points: 35, emoji: "🍍", weight: 8 }
};

const POWERUP_TYPES = {
    speed_boost: { color: "#00ffff", duration: 5000, emoji: "⚡", description: "Speed Boost", weight: 10 },
    invincible: { color: "#ffd700", duration: 3000, emoji: "🛡️", description: "Invincible", weight: 5 },
    double_points: { color: "#8a2be2", duration: 8000, emoji: "💎", description: "Double Points", weight: 8 },
    ghost_mode: { color: "#c8c8c8", duration: 4000, emoji: "👻", description: "Ghost Mode", weight: 6 },
    shrink: { color: "#1e8cff", duration: 6000, emoji: "🔵", description: "Shrink Snake", weight: 7 },
    magnet: { color: "#ff4500", duration: 7000, emoji: "🧲", description: "Food Magnet", weight: 9 }
};
...
class Game {
    ...
    setupShopUI() {
        ...
        Object.entries(POWERUP_TYPES).forEach(([type, props]) => {
            ...
            item.innerHTML = `
                ...
                ${level < 5 ? `<div class="shop-cost">Upgrade → Level ${nextLevel}: Cost ${BOOST_LEVELS[nextLevel].cost_coins} coins</div>` : ''}
            `;
    ...
    updateSidebar() {
        ...
        sidebarContent.innerHTML = `
            ...
            <div class="sidebar-box">
                <div style="font-size: 12px;">🪙 Coin / 💎 Diamond: shop currency</div>
            </div>
        `;
    }
